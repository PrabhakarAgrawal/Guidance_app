...
class aspirantPostScreen extends StatefulWidget {
  const aspirantPostScreen({Key? key}) : super(key: key);

  @override
  State<aspirantPostScreen> createState() => _aspirantPostScreenState();
}

class _aspirantPostScreenState extends State<aspirantPostScreen> {
  String uid = '';
  String username = '';
  String profilePic = '';
  String college = '';
